...
statusList = ["Xenoblade Chronicles 3", "The Eternal Now", "The Cycle of Rebirth"]
...
@bot.slash_command(guild_ids = testGuildList)
async def hello(ctx):
...
#Automatically loop through all files in cog directory and make the bot recognise them
